...
function Mattressessproduct ({ response ,response1,response2}) {
  //ADD TO CART REDUX
                        ...
                        >
                          <div className="row pt-2">
                            <div className="col-md-2 col-6">
                              <img
                               ...
                               src={bed.images[0]}
                                style={{ width: "94px" }}
                                alt=""
                                onClick={() => router.push(`/mattressess/Mattressessproduct?title=${bed.product_name}&size=${bed.size}`)
                              }
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={() => router.push(`/mattressess/Mattressessproduct?title=${bed.product_name}`)
                              }>
                                <b>ADD</b>
                              </button>
                            </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/mattressess/Mattressessproduct?title=${bed.product_name}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const data2 = await axios.post(
    `${process.env.BASE_URL}/api/mattress/lastproduct`,
    {
      method: "product_name",
      value: title,
    }
