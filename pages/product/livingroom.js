...
function LivingRoom({response}) {
  ...
  useEffect(()=>{
    ...
    router.push(`/product/livingroom?${category?"category="+category:""}${maxPrice ? category?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)
                ...
                <div className="row" style={{ padding: "10px" }}>
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      >
                        <option label="livingroom" />
                        <option value="Tables" label="Tables" />
                        <option value="Shelf" label="Shelf" />
                        <option value="Chairs" label="Chairs" />
                        <option value="Chest Drawers" label="Chest Drawers" />
                        <option value="Wardrobes" label="Wardrobes" />
                        <option value="Tub Chairs" label="Tub Chairs"/>
                  ...
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      onChange={(e) =>{
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/product/livingroom?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.category?"&category="+router.query.category:""}`)
...
export async function getServerSideProps(context) {
    ...
    const data = await axios.get(
      `${process.env.BASE_URL}/api/livingroom/bestproducts?category=${category}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
    );
