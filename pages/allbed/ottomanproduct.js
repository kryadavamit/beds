                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          ...
                                          function (beds) {
                                            beds.size === "4FT 6"?beds.size:"not found";
                                            
                                          }
                                        );
                                        setSize('4FT 6')
                                        setImage(
                                        setSize('4FT 6')?newarray[0].images[0].color1.base_url:"/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
                                        );
                                        setBed(newarray[0]);
                              ...
                              <div className="bg-white sleigh-cusHeight">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    {bed?.mattresses_images?.map((mattress) => {
                                      ...
                                      if (mattress.image) {
                                        return (
                                          <div
                                          className={`col-md-3 productimghover ${
                                            image === mattress.image ? "activeSize" : ""
                                          }`}
                                            onClick={() => {
                                    ...
                                    <div
                                      className={`col-md-3 productimghover ${
                                        image === "/assets/images/newicons/Mattress-03.png" ? "activeSize" : ""
                                      }`}
                                      onClick={() => {
                                        setImage(
                                          "/assets/images/newicons/Mattress-03.png"
                        ...
                        >
                          <div className="row pt-2">
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=> router.push(`/allbed/ottomanproduct?title=${bed.product_name}&size=${bed.size}&colorName=${router.query.colorName}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/allbed/ottomanproduct?title=${bed.product_name}&size=${bed.size}&colorName=${router.query.colorName}`
                                    )
                                  }
                                  className="image"
                                >
                ...
                <div className="row">
                  <div className="col text-center">
                    <button
                      ...
                      style={button}
                      onClick={() => router.push(`/allbed/ottoman-bed`)}
                    >
                      VIEW ALL PRODUCTS
                    </button>
                  </div>
...
export async function getServerSideProps(context) {
  ...
  const data2 = await axios.post(
    `${process.env.BASE_URL}/api/allbeds/ottoman/lastproduct`,
    // {
    //   method: "product_name",
    //   value: title,
    //   // method: "size",
