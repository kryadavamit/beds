        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Suede fabric divan beds</h1>
            ...
            <div className="container mt-6 mb-2 rounded linen-fabric-filter" >
              <div className="row"  style={{padding:"10px"}}>
                  ...
                  <select className="dropdown-section"
                   ...
                   onChange={(e) =>
                     router.push(`/divanbed/suede-Fabric-Divan-Beds?size=${e.target.value}`)
                  ...
                  <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/divanbed/suede-Fabric-Divan-Beds/?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)
