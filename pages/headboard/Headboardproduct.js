...
function Headboardproduct({ response,response1 ,response2}) {
  //ADD TO CART REDUX
                            ...
                            <Tab.Pane eventKey="first">
                              <div className="bg-white cusHeight Headboard-page">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    <div
                                      className={`col-md-3 productimghover ${size==='2FT 6' ? 'activeSize':""}`}
                                      onClick={() => {
                                    ...
                                    <div
                                      ...
                                      className={`col-md-3 productimghover ${size==='3FT' ? 'activeSize':""}`}
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          function (beds) {
                                    ...
                                    <div
                                       className={`col-md-3 productimghover ${size==='4FT' ? 'activeSize':""}`}
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          function (beds) {
                                    ...
                                    <div
                                      ...
                                      className={`col-md-3 productimghover ${size==='4FT 6' ? 'activeSize':""}`}
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          function (beds) {
                                  ...
                                  <div className="row mt-2"> */}
                                    <div
                                     className={`col-md-3 productimghover ${size==='5FT' ? 'activeSize':""}`}
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          function (beds) {
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    <div
                                      ...
                                      onClick={() => {
                                        // setImage(bed?.images[0].url?bed.images[0].url:"/logo (1).png");
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setColorName("Grey Suede");//grey Suede
                                      }}
                                    >
                                      <Image
                                        id="img_8"
                                    ...
                                    <div
                                     className={`col-md-3 productimghover ${colorName==='Chenille' ? 'activeSize':""}`}
                                      onClick={() => {
                                        ...
                                        setColorName("Chenille");//Chennilie
                                      }}
                                    >
                                      <Image
                                        id="img_9"
                                    ...
                                    className={`col-md-3 productimghover ${colorName==='Black Crushed' ? 'activeSize':""}`}
                                      onClick={() => {
                                        ...
                                        setColorName("Black Crushed");//Black Crushed
                                      }}
                                    >
                                      <Image
                                        id="img_10"
                        ...
                        >
                          <div className="row pt-2">
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={() => router.push(`/headboard/Headboardproduct?title=${bed.product_name}&size=${bed.size}&color=${router.query.color}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/headboard/Headboardproduct?title=${bed.product_name}&size=${bed.size}&color=${router.query.color}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const data1 = await axios.post(`${process.env.BASE_URL}/api/headboard/getbeds`, {
    
    method: "size",
    value: size,
  });

  const data2 = await axios.post(`${process.env.BASE_URL}/api/headboard/lastproduct`, {
