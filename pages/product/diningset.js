...
function DiningSet({response}) {
  ...
  useEffect(()=>{
    ...
    router.push(`/product/diningset?${category?"category="+category:""}${maxPrice ? category?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)
...
<div className="single-box">
                               <a href="/diningset/2seaterdiningset"> <Image width={180} height={100} src="/assets/images/DivanBedsicon/Group 477.svg" alt="Product" /></a>
                            ...
                            <div className="single-box">
                               <a href="/diningset/4seaterdiningset"> <Image width={180} height={100} src="/assets/images/DivanBedsicon/Group 478.svg" alt="Product" /></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> 4 Seater</b></p>
                            </div>


                            <div className="single-box">
                                <a href="/diningset/6seaterdiningset"><Image width={180} height={100} src="/assets/images/DivanBedsicon/Group 479.svg"  alt="Product"/></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> 6 Seater </b></p>
                            </div>

                            <div className="single-box">
                                <a href="/diningset/8seaterdiningset"><Image width={180} height={100} src="/assets/images/DivanBedsicon/Group 480.svg" alt="Product" /></a>
                ...
                <div className="row" style={{ padding: "10px" }}>
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      >
                        <option label="--diningset--" />
                        <option value="2 Seater Dining Set" label="2 Seater Dining Set" />
                        <option value="4 Seater Dining Set" label="4 Seater Dining Set" />
                        <option value="6 Seater Dining Set" label="6 Seater Dining Set" />
                        <option value="8 Seater Dining Set" label="8 Seater Dining Set" />
                        <option value="3 Seater Dining Set" label="3 Seater Dining Set" />
                    ...
                    >
                      ...
                      {/* <select className="dropdown-section"
                       onChange={(e) =>{
                        ...
                        <option label="Color" />
                        <option value={JSON.stringify({images:"grey Linen"})} label="Grey Linen" />
                        <option value={JSON.stringify({images:"grey Suede"})} label="Grey Suede" />
                        <option value={JSON.stringify({images:"Charcoal Chennille"})} label="Chenille" />
                        <option value={JSON.stringify({images:"Black Crushed"})} label="Black Crushed" />
                  ...
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      onChange={(e) =>{
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/product/diningset?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.category?"&category="+router.query.category:""}`)
...
export async function getServerSideProps(context) {
  ...
  const maxPrice = query?.maxPrice ? query.maxPrice:"";
    ...
    const data = await axios.get(
      `${process.env.BASE_URL}/api/diningset/bestproducts?category=${category}&maxPrice=${maxPrice}&minPrice=${minPrice}`,
    );
