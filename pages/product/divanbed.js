...
function Divanbed({ response }) {
  ...
  // const [gery_linen,setgrey_linen]=useState(response[0].images[0].color1)
  // let king=[];
  // king.push(response[0].images[0].color1)
  // 

  // switch (color) {
  //   case 'Grey Linen':
  //     
  //     return response[0].images[0].color1.base_url
  //     break;
  //   case 'Grey Suede':
  //     
  //     return response[0].images[0].color2
  //     break;
  //   case 'Charcoal Chenille':
  //     
  //     return response[0].images[0].color3.base_url
  //     // expected output: "Mangoes and papayas are $2.79 a pound."
  //     break;
  //   default:
  //     return response[0].images[0].color4.base_url

  // }

  var divanBedColor;
  if (router.query.images) {
    divanBedColor = response?.filter(function (beds) {
  ...
  useEffect(() => {
    ...
    router.push(`/product/divanbed?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
        ...
        <div>
              ...
              <div className="row">
                <div className="size-box">
                  ...
                  <div className="single-box">
                    ...
                    >
                      {" "}
                      <b> Charcaol Chenille</b>
                    </p>
                  </div>

                  <div className="single-box">
                    <a href="/divanbed/black-crushed">
                      <Image
                        priority={true}
                        width={100}
                        height={120}
          ...
          <div className="container mt-10">
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/product/divanbed?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)


                      }}>
                      <option label="Price" />
                      <option value={JSON.stringify({ maxPrice: 100, minPrice: 50 })} label="50-100" />
                      <option value={JSON.stringify({ maxPrice: 150, minPrice: 101 })} label="101-150" />
            ...
            <div className="row">
              {response.map((item) => {
                switch (item.category) {
                  case "Linen Fabric DivanBeds": imageUrl!="color3";
                    
                    break;

                  case "Chenille Fabric DivanBeds": imageUrl!="color4";
                ...
                var colorName;
                switch(imageUrl){
                  case "color1": item.category==="Linen Fabric DivanBeds"?colorName="Grey Linen":item.category==="Chenille Fabric DivanBeds"?colorName="Cream":colorName="Grey Linen";
                  break;
                  case "color2": 
                  // colorName="Grey Suede";colorName="Black Cotton";colorName="Charcoal";
                  item.category==="Linen Fabric DivanBeds"?colorName="Black Cotton":item.category==="Chenille Fabric DivanBeds"?colorName="Charcoal":colorName="Grey Suede";
                  break;
                  case ((item.category!="Linen Fabric DivanBeds")||(item.category!="Chenille Fabric DivanBeds"))?"color3":"": colorName="Chenille";
                  break;
