...
function Ottomanbed({response}){
  ...
  useEffect(() => {
    ...
    router.push(`/allbed/ottoman-bed?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Ottoman beds</h1>
...
export async function getServerSideProps(context) {
  ...
  const maxPrice = query?.maxPrice ? query.maxPrice : "";
    ...
    const data = await axios.get(
      ...
      `${process.env.BASE_URL}/api/allbeds/ottoman/bestproducts?size=${size}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
      // {
      //   method: "category",
      //   value: 'Ottoman Beds',
      // }
