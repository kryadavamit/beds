...
function Livingeoomproduct({ response ,response2,response3}) {
  //ADD TO CART REDUX
 ...
 const colorname=router.query.colorName
  ...
  useEffect(() => {
    ...
    // setImage(setImage(response[0].images[0].color1.base_url))
                          ...
                          <div className="row pt-2">
                            <div className="col-md-2 col-6">
                              <img
                                ...
                                style={{ width: "94px" }}
                                alt=""
                                onClick={()=> router.push(`/allbed/allbedsproduct?title=${bed.product_name}`)}
                              />
                            </div>
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=> router.push(`/allbed/allbedsproduct?title=${bed.product_name}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/allbed/allbedsproduct?title=${bed.product_name}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const data2 = await axios.post(
    `${process.env.BASE_URL}/api/allbeds/lastproduct`,
    {
      method: "product_name",
      value: title,
  ...
  return {
    props: { response ,response2 ,response3}, // will be passed to the page component as props
  };
}
