...
function SleighbedBox({response}){
  ...
  useEffect(() => {
    ...
    router.push(`/allbed/sleigh-beds?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Sleigh Beds</h1>
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/allbed/sleigh-beds?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)
...
export async function getServerSideProps(context) {
  ...
  `${process.env.BASE_URL}/api/allbeds/sleighbed/bestproducts?size=${size}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
// {
//     method: "category",
