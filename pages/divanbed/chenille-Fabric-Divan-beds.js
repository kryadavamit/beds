...
function Linenfabric({response}){
  ...
  const filterItem =(cateItem) => {
    ...
    useEffect(() => {
      ...
      router.push(`/divanbed/chenille-Fabric-Divan-Beds?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
                ...
                <div className="col-md-3">
                  ...
                  >
                    ...
                    <select className="dropdown-section"
                      ...
                      <option label="Color" />
                      <option value={"color1"} label="Cream" />
                      <option value="color2" label="Charcoal" />
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/divanbed/chenille-Fabric-Divan-Beds?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)
...
<div className="row">
                {response.map((item) => {
                  ...
                  var colorName;
                switch(imageUrl){
                  case "color1": colorName="Cream";
                  break;
                  case "color2": colorName="Charcoal";
                  break;
...
export async function getServerSideProps(context) {
 ...
 // const size = query?.__NEXT_INIT_QUERY?.size;
  ...
  const category = "Chenille Fabric DivanBeds";
