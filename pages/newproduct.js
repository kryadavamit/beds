...
function NewProduct({ response, response1, response2 }) {
  ...
  const addToCartHandler = () => {
    dispatch(addToCart(bed._id, parseInt(qty), colorName,total));
    router.push("/cart");
  };

  const Image_Not_Found="/assets/images/image/no-image-found.png"
  return (
    <div>
      <div>
        <Head>
                                  ...
                                  <div className="row">
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setSize("2FT 6");
                                        setBed(newarray[0]);
                                        size==="2FT 6"? setColor(newarray[0].images[0].color1):"";
                                      }}
                                    >
                                      <Image
                                        id="img_1"
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setBed(newarray[0]);
                                        setColor(size==="3FT"?newarray[0].images[0].color1:Image_Not_Found);
                                        setSize("3FT");
                                      }}
                                    >
                                      <Image
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        var newarray = response?.filter(
                                          function (beds,colorName) {
                                            return beds.size== "4FT";
                                            // beds.size?.colorName?"4FT":""
                                          }
                                        );
                                        size==="4FT"?setImage(
                                          newarray[0].images[0].color1.base_url
                                        ...
                                        setBed(newarray[0]);
                                        size==="4FT"?setColor(newarray[0].images[0].color1):"";
                                        setSize("4FT");
                                      }}
                                    >
                                      <Image
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setSize("4FT 6");
                                        setImage(
                                          size==="4FT 6"?newarray[0].images[0].color1.base_url
                                        :Image_Not_Found);
                                  ...
                                  <div className="row mt-2"> */}
                                    <div
                                      ...
                                      onClick={() => {
                                       ...
                                       size==="5FT"? setColor(newarray[0].images[0].color1):"";
                                        setSize("5FT");
                                        setBed(newarray[0]);
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                       ...
                                       size==="6FT"? setColor(newarray[0].images[0].color1):"";
                                        setBed(newarray[0]);
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              ...
                              <Checkout
                                ...
                                headboardPrice={headboard}
                                mattressPrice={mattress}
                                FeetPrice={feets}
                                type="beds"
                                bedColor={colorName}
