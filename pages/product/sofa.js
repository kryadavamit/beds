...
function Sofa({ response }) {
  ...
  useEffect(() => {
    ...
    router.push(`/product/sofa?${size ? "size=" + size : ""}${category ? "&category=" + category : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}`)
                ...
                <div className="col-md-3">
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="5 Seater" label="5 Seater" />
                      <option value="6 Seater" label="6 Seater" />
                    </select>
                  </span>
                </div>
                <div className="col-md-3">
                  ...
                  >
                    ...
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        // router.push(`/product/category?category=${value.category}`)
                      }}>



                      <option label="Category" />
                      <option value="Leather Sofa" label="Leather Sofa" />
                      <option value="Fabric Sofa" label="Fabric Sofa" />
                      <option value="Leather Sofa" label="Leather Sofa" />
                      <option value="Fabric Sofa" label="Fabric Sofa" />
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/product/sofa?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}${router?.query?.category ? "&category=" + router.query.category : ""}`)
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.get(
    `${process.env.BASE_URL}/api/sofa/bestproducts?size=${size}&minPrice=${minPrice}&maxPrice=${maxPrice}&category=${category}`,
