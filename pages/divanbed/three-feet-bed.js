...
function Threefeetbed({response}){
  ...
  const filterItem =(cateItem) => {
    ...
    useEffect(() => {
      ...
      router.push(`/divanbed/three-feet-bed?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Single Divan Beds</h1>
                ...
                <div className="col-md-3">
                  ...
                  >
                    <select
                      ...
                      onChange={(e) =>
                        router.push(`/divanbed/three-feet-bed?size=${e.target.value}`)
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/divanbed/two-feet-bed?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)
...
export async function getServerSideProps(context) {
    ...
    const data = await axios.post(
      `${process.env.BASE_URL}/api/products/getbeds?size=${size}`,
      {
        method: "size",
        value: sizes,
      }
