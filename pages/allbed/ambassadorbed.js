...
function Ambassadodrbed({response}){
  ...
  useEffect(() => {
    ...
    router.push(`/allbed/ambassadorbed?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Ambassador  Range</h1>
...
export async function getServerSideProps(context) {
  ...
  const category='Ambassador Range';
