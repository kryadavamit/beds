...
function Twoseater({response}){
  ...
  useEffect(()=>{
    ...
    router.push(`/sofa/1seatersofa?${size?"size="+size:""}${maxPrice ? size?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>1 Seater Sofa</h1>
                    ...
                    >
                     ...
                     <select className="dropdown-section"
                      onChange={(e) =>{
                        ...
                        router.push(`/sofa/1seatersofa?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size?"&size="+router.query.size:""}`)
