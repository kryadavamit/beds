...
function Sixfeetbed({response}){
  ...
  const [size, setSize] = useState("6FT");
  ...
  useEffect(() => {
    ...
    router.push(`/divanbed/six-feet-bed?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
