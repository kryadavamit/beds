        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Dining Tables</h1>
          ...
          <div className="row">
            <div className="size-box">
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">   Dining Chairs </p>
              </div>
