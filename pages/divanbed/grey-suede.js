...
function greySuede({response}){
  ...
  const [size, setSize] = useState("2FT 6");
  ...
  useEffect(() => {
    ...
    router.push(`/divanbed/grey-suede?${size ? "size=" + size : ""}${maxPrice ? size ? "&maxPrice=" + maxPrice : "maxPrice=" + maxPrice : ""}${minPrice ? "&minPrice=" + minPrice : ""}${images ? "&color=" + images : ""}`)
                ...
                <div className="col-md-3">
                  ...
                  >
                    <select
                      ...
                      onChange={(e) =>
                        router.push(`/divanbed/grey-suede?size=${e.target.value}`)
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        setMinPrice(value.minPrice);
                        router.push(`/divanbed/grey-suede?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}&color=${value.images}`)
...
export async function getServerSideProps(context) {
  ...
  let sizes = "";
  const color = req?.__NEXT_INIT_QUERY?.color;
