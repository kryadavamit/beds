...
function Livingeoomproduct({ response ,response1 ,response2}) {
  //ADD TO CART REDUX
                          ...
                          <div className="row pt-2">
                            <div className="col-md-2 col-6">
                              <img
                                ...
                                onClick={()=>router.push(`/livingroom/Livingroomproduct?title=${bed.product_name}`)}
                              />
                            </div>
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=>router.push(`/livingroom/Livingroomproduct?title=${bed.product_name}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/livingroom/Livingroomproduct?title=${bed.product_name}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
 ...
 const title = req?.__NEXT_INIT_QUERY?.title;
  ...
  const data2 = await axios.post(
    `${process.env.BASE_URL}/api/livingroom/lastproduct`,
    // {
