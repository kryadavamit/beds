...
function Mattressess({ response }) {
  ...
  useEffect(()=>{
    ...
    router.push(`/product/Mattressess?${size?"size="+size:""}${maxPrice ? size?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)
                  ...
                  >
                    <select className="dropdown-section"
                      onChange={(e) => {
                        ...
                        router.push(`/product/Mattressess?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size ? "&size=" + router.query.size : ""}`)
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.get(
    `${process.env.BASE_URL}/api/mattress/bestproductmattress?size=${size}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
  );
