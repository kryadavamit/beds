...
import HeadboardBox from "../../components/comps/SleighbedsBox";
...
function myShop({ response }) {
  ...
  const [imageindex, setImageindex] = useState("color1");
  const [image1index, setImage1index] = useState("0");

  useEffect(() => {
    router.push(
      `/product/myShop?${size ? "size=" + size : ""}${type? "type=" +type: ""}${
        maxPrice
          ? size
            ? "&maxPrice=" + maxPrice
            : "maxPrice=" + maxPrice
  ...
  }, [size, maxPrice, minPrice,type]);

  let index = 0;
  if (imageindex == "color1") {
    index = 0;
  } else if (imageindex == "color2") {
    index = 1;
  } else if (imageindex == "color3") {
    index = 2;
  } else if (imageindex == "color4") {
    index = 3;
  }
  ...
  return (
    <div>
      <div>
        <Head>
          <title>DivanBed All Products</title>
            ...
            <div className="container mt-10">
                ...
                <div className="row" style={{ padding: "10px" }}>
                  ...
                  <div className="col-md-3">
                    ...
                    >
                      ...
                      >
                        <option label="type" />
                        <option value="bed" label="Bed" />
                        <option value="ottoman" label="Ottoman" />
                        <option value="sleighbed" label="Sleighbed" />
                        <option value="headboard" label="Headboard" />
                        <option value="mattress" label="Mattress" />
                        <option value="sofa" label="Sofa" />

                        <option value="gardenFurniture" label="Garden Furniture" />
                        <option value="livingRoom" label="Living Room" />
              ...
              <div className="row">
                {response.map((item) => {
                  ...
                  // switch(imageindex){
                  //   case "color1": imageindex="color1";
                  //   case "color2":imageindex="color2";
                  //   case "color3": imageindex="color3";
                  //   case "color4": imageindex="color4";
                  //   case "0":  imageindex="0";
                  //   case "1": imageindex="1";
                  //   case "2": product_image="2";
                  //   case "3": product_image="3";

                  // }

                  switch (item.type) {
                    case "bed":
                      imageUrl = item.images[0][imageindex].base_url;
                  ...
                  //  }
                    ...
                    item.type == "allbeds" &&
                    (item.category == "Kids Beds" ||
                      item.category == "Leather Beds" ||
                      item.category == "Nevada Beds")
                  ) {
                    return (
                      <AllbedsBox
                        src={imageUrl}
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.get(
    // `${process.env.BASE_URL}/api/allbeds/getbeds?size=${size}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
    `${process.env.BASE_URL}/api/shop?size=${size}&type=${type}&minPrice=${minPrice}&maxPrice=${maxPrice}`
    // {
    //   method: "size",
    //   value: sizes,
    // }
