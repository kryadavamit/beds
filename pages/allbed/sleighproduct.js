...
function NewProduct({ response,response1 ,response2}) {
 ...
 if(router.query.colorName){
  divanBedsColorName = response?.filter(
   function (beds) {
 ...
 var product_color;
  switch(image_color){
    case "Grey Linen": product_color="color1";
    break;
    case "Grey Suede": product_color="color2";
    break;
    case "Chenille": product_color="color3";
    break;
    case "Black Crushed": product_color="color4";
    break;
  }
                      ...
                      <Row>
                        <Col sm={3} xs={12}>
                          <Nav variant="pills" className="flex-column">
                            ...
                            <Nav.Item>
                              <Nav.Link eventKey="five">Button</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                        ...
                        <Col sm={9} col xs={12}>
                          <Tab.Content>
                            <Tab.Pane eventKey="first">
                              <div className="bg-white sleigh-cusHeight">
                                <div className="row">
                              ...
                              <div className="bg-white sleigh-cusHeight">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    <div
                                     className={`col-md-3 productimghover ${
                                      colorName === "Grey Linen" ? "activeSize" : ""}`}
                                      onClick={() => {
                                        setImage(
                                          (bed?.images[0].color1.base_url)?bed.images[0].color1.base_url:"/assets/images/image/no-image-found.png"
                                        );
                                    ...
                                    <div
                                     className={`col-md-3 productimghover ${
                                      colorName === "Grey Suede" ? "activeSize" : ""}`}
                                      onClick={() => {
                                        setImage(
                                          (bed?.images[0].color2.base_url)?bed.images[0].color2.base_url:"/assets/images/image/no-image-found.png"
                                        );
                                    ...
                                    <div
                                      className={`col-md-3 productimghover ${
                                        colorName === "Chenille" ? "activeSize" : ""}`}
                                      onClick={() => {
                                        setImage(
                                          (bed?.images[0].color3.base_url)?bed.images[0].color3.base_url:"/assets/images/image/no-image-found.png"
                                          
                                        );
                                        setColor(bed?.images[0].color3);
                                        setColorName("Chenille");
                                      }}
                                    >
                                      <Image
                                        id="img_9"
                                    ...
                                    <div
                                     className={`col-md-3 productimghover ${
                                      colorName === "Black Crushed" ? "activeSize" : ""}`}
                                      onClick={() => {
                                        setImage(
                                          (bed?.images[0].color4.base_url)?bed.images[0].color4.base_url:"/assets/images/image/no-image-found.png"
                                        );
                              ...
                              <div className="bg-white sleigh-cusHeight">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    ...
                                    */}
                                    {bed?.images?.map((images)=>{
                                      if(images.color2){
                                      return(
                                        <div
                                        className={`col-md-3 productimghover ${
                                         image === images.color2.base_url ? "activeSize" : ""}`}
                                         onClick={() => {
                                           setImage(
                                            images.color2.base_url
                                           );
                                           setHeadboard(parseInt(0));
                                           setHeadboardColorName("Grey Suede");
                                         }}
                                       >
                                         <Image
                                           id="img_82"
                                        ...
                                        return(
                                          <div
                                          className={`col-md-3 productimghover ${
                                           image === images.color1.base_url ? "activeSize" : ""}`}
                                           onClick={() => {
                                             setImage(
                                              images.color1.base_url
                                             );
                                             setHeadboard(parseInt(0));
                                             setHeadboardColorName("Grey Linen");
                                           }}
                                         >
                                           <Image
                                             id="img_82"
                                    ...
                                    <div
                                     className={`col-md-3 productimghover ${
                                      image === images.color2.Button2? "activeSize" : ""}`}
                                      onClick={() => {
                                        setImage(
                                         images.color2.Button2
                                        );
                                        setHeadboard(parseInt(0));
                                        setHeadboardColorName(
                                         "Grey Suede"
                                    ...
                                    >
                                      <Image
                                        ...
                                        height={100}
                                        src={
                                          "/assets/images/newicons/headboard-01.png"
                                        }
                                      />
                                      <span className="productcolor">
                                      {"Diamond Button"}
                                    ...
                                    else if(images.color3){
                                      return(
                                      
                                        <div
                                         className={`col-md-3 productimghover ${
                                          image === images.color3.Button2? "activeSize" : ""}`}
                                          onClick={() => {
                                            setImage(
                                             images.color3.Button2
                                            );
                                            setHeadboard(parseInt(0));
                                            setHeadboardColorName(
                                             "Chenille"
                                  ...
                                  else if(images.color4){

                                    return(
                                      
                                      <div
                                       className={`col-md-3 productimghover ${
                                        image === images.color4.Button2? "activeSize" : ""}`}
                                        onClick={() => {
                                          setImage(
                                           images.color4.Button2
                                          );
                                          setHeadboard(parseInt(0));
                                          setHeadboardColorName(
                                    ...
                                    return(
                                      ...
                                      <div
                                       className={`col-md-3 productimghover ${
                                        image === images.color1.Button2? "activeSize" : ""}`}
                                        onClick={() => {
                                          setImage(
                                           images.color1.Button2
                                          );
                                          setHeadboard(parseInt(0));
                                          setHeadboardColorName(
                                           "Grey Linen"
                              ...
                              <div className="bg-white sleigh-cusHeight">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    ...
                                    <div
                                     className={`col-md-3 productimghover ${
                                      image === "/assets/images/newicons/Mattress-03.png"
                        ...
                        >
                          <div className="row pt-2">
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=>router.push(`/allbed/sleighproduct?title=${bed.product_name}&category=${bed.category}&size=${bed.size}&colorName=${router.query.colorName}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/allbed/sleighproduct?title=${bed.product_name}&category=${bed.category}&size=${bed.size}&colorName=${router.query.colorName}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
    ...
    `${process.env.BASE_URL}/api/allbeds/sleighbed/getbeds`,
    {
      method: "product_name",
      value: title,
  ...
  const data2 = await axios.post(
    //`${process.env.BASE_URL}/api/allbeds/getbeds`,
    `${process.env.BASE_URL}/api/allbeds/sleighbed/lastproduct`,
    // {
