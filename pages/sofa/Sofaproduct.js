...
function Sofaproduct ({ response ,response1 ,response2}) {
  //ADD TO CART REDUX
  ...
  var headColor=router.query.color
   var divanBedColor;
  ...
  var product_color;
  switch(headColor){
    case "Grey Linen": product_color="0";
    break;
    case "Grey Suede": product_color="1";
    break;
    case "Chenille": product_color="2";
    break;
    case "Black Crushed": product_color="3";
    break;
  }
  ...
  useEffect(() => {
    ...
    setColorName(router.query.color)
    setImage(divanBedSize[0].images[product_color].url)
                            ...
                            <Tab.Pane  eventKey="first">
                              <div className="bg-white dining-cusHeight Headboard-page">
                                ...
                                <div className="container-fluid slider-Mobile">
                                  <div className="row">
                                    <div
                                      className={`col-md-3 productimghover ${colorName==='Grey Linen' ? 'activeSize':""}`}
                                      onClick={() => {
                                        setImage(
                                          bed?.images[0].url?bed.images[0].url: "/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
                                        );
                                        setColor(bed?.images[0]);
                                        setColorName("Grey Linen");//Grey Linen
                                      }}
                                    >
                                      <Image
                                        id="img_7"
                                    ...
                                    <div
                                      className={`col-md-3 productimghover ${colorName==='Grey Suede' ? 'activeSize':""}`}
                                      onClick={() => {
                                        setImage(
                                          bed?.images[1].url?bed.images[1].url: "/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
                                        );
                                        setColor(bed?.images[1]);
                                        setColorName("Grey Suede");//Grey Linen
                                      }}
                                    >
                                      <Image
                                        id="img_8"
                                    ...
                                    <div
                                      className={`col-md-3 productimghover ${colorName==='Chenille' ? 'activeSize':""}`}
                                      onClick={() => {
                                        setImage(
                                          bed?.images[2].url?bed.images[2].url: "/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
                                        );
                                        setColor(bed?.images[2]);
                                        setColorName("Chenille");//Grey Linen
                                      }}
                                    >
                                      <Image
                                        id="img_9"
                                    ...
                                    <div
                                      className={`col-md-3 productimghover ${colorName==='Black Crushed' ? 'activeSize':""}`}
                                      onClick={() => {
                                        setImage(
                                          bed?.images[3].url ? bed.images[3].url: "/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
                                         


                                        );
                                        setColor(bed?.images[3]);
                                        setColorName("Black Crushed");//grey Suede
                                      }}
                                    >
                                      <Image
                                        id="img_10"
                        ...
                        <div className="scndbtn">
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              ...
                              <Checkout addToCartHandler={addToCartHandler} price={total} type="sofa" sofaColor={colorName}/>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        >
                          ...
                          <div className="row pt-2">
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=>router.push(`/sofa/Sofaproduct?title=${bed.product_name}&size=${bed.size}&color=${router.query.color}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/sofa/Sofaproduct?title=${bed.product_name}&size=${bed.size}&color=${router.query.color}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const data2 = await axios.post(
    //"http://localhost:3000/api/sofa/getsofa",
    `${process.env.BASE_URL}/api/sofa/lastproduct`,
    // {
    //   method: "size",
    //   value: size,
    //   // method: "size",
