...
function DiningSet({response}) {
  ...
  useEffect(()=>{
    ...
    router.push(`/product/diningset?${category?"categoey="+category:""}${maxPrice ? size?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)

  },[size,maxPrice,minPrice,category])
