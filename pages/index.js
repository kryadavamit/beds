            ...
            <Tabs>
              ...
              <TabPanel>
                ...
                <div
                  ...
                  style={{ marginTop: "3px", marginBottom: "-66px" }}
                >
                  <button
                    className="ShopMobile"
                    style={{
                ...
                return (
                  <div className="product productNew sliderProduct">
                    <div className="thumb">
                      ...
                      <button
                        onClick={() =>
                          router.push(`/newproduct?title=${bed.product_name}&size=${bed.size}&colorName=${colorName}`)
                        }
                        className="image"
                      >
                        <Image
                ...
                return (
                  <div className="product productNew sliderProduct">
                    <div className="thumb">
                      <button
                        onClick={() =>
                          router.push(`/newproduct?title=${bed.product_name}&size=${bed.size}`)
                        }
                        className="image"
                      >
                        <Image
      ...
      <div className="section pt-6 pb-6 explore-mattress">
        <div className="container">
          ...
          <div className="container">
            <div className="row">
              <div
                className="col-12 mattres-sectionb"
