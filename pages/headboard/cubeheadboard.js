...
function CubeHeadboard({response}){
  ...
  useEffect(()=>{
    ...
    router.push(`/headboard/cubeheadboard?${size?"size="+size:""}${maxPrice ? size?"&maxPrice="+maxPrice:"maxPrice="+maxPrice : ""}${minPrice? "&minPrice="+minPrice:""}`)
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Diamond Cube Headboard</h1>
                  ...
                  <div className="col-md-3">
                    ...
                    >
                     ...
                     <select
                        className="dropdown-section"
                        onChange={(e) =>
                          router.push(`/headboard/cubeheadboard?size=${e.target.value}`)
                    ...
                    >
                     ...
                     <select className="dropdown-section"
                      onChange={(e) =>{
                        ...
                        router.push(`/headboard/cubeheadboard?maxPrice=${value.maxPrice}&minPrice=${value.minPrice}${router?.query?.size?"&size="+router.query.size:""}`)
