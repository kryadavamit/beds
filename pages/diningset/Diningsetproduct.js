...
function Diningset ({ response ,response1,response2}) {
  //ADD TO CART REDUX
  ...
  // var product_name;
  // product_name=router.query.title.split("-").join(" ")
  // 
                        ...
                        >
                          ...
                          <div className="row pt-2">
                            ...
                            <div className="col-md-4">
                              <button className="ProductPageB " onClick={()=> router.push(`/diningset/Diningsetproduct?title=${bed.product_name}`)}>
                                <b>ADD</b>
                              </button>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        {/* <Image width={128} height={128} className="hover-image" src="/assets/images/product-image/2.jpg" alt="Product" /> */}
                                ...
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/diningset/Diningsetproduct?title=${bed.product_name}`
                                    )
                                  }
                                  className="image"
                                >
...
export async function getServerSideProps(context) {
  ...
  const timestamp = req?.__NEXT_INIT_QUERY.timestamp;
  const maxtime= new Date(Math.max.apply(null,timestamp));
  ...
  const data1 = await axios.post(
   ...
   const data2 = await axios.post(
    // "https://staggingx.bedsdivans.co.uk/api/products/getbeds",
    `${process.env.BASE_URL}/api/diningset/lastproduct`,
    //  {
