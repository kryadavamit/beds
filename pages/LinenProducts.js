...
function NewProduct({ response, response1, response2 }) {
    ...
    const src4 = "/assets/images/background-images/preview-chat-banner-for-product-page-final-Dec.png"
    return (
        <div>
            <div>
                <Head>
                ...
                <div>
                    ...
                    >
                        {/* <Image
                            src="/assets/images/background-images/preview-chat-banner-for-product-page-final-Dec.png"
                            width={2000}
                            height={757}
                            id="shwimg_1"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mt-4 outer-tab-section">
                                  ...
                                  <div className="row mt-2"> */}
                                                                        ...
                                                                        <div
                                                                            className={`col-md-3 productimghover ${size === "6FT" ? "activeSize" : ""
                                                                                }`}
                                                                            onClick={() => {
                                                                                var newarray = response?.filter(
                                                                                    function (beds) {
        ...
        <Image width={100} height={80} src="/assets/images/image/box-image.png"/>
                                    ...
                                    <span className="cusSize">Choose Size</span>*/}
                                                                ...
                                                                <div className="container-fluid slider-Mobile">
                                                                    <div className="row">
                                                                        <div
                                                                            className={`col-md-3 productimghover ${colorName === "Grey Linen"
                                                                                ? "activeSize"
                                                                                : ""
                                                                                }`}
                                                                            onClick={() => {
                                                                        ...
                                                                        <div
                                                                            className={`col-md-3 productimghover ${colorName === "Black Cotton"
                                                                                ? "activeSize"
                                                                                : ""
                                                                                }`}
                                                                            onClick={() => {
                                                                    ...
                                                                    <div className="row">
                                                                        ...
                                                                        {color?.storage?.map((storage) => {
                                                                            if (storage.url) {
                                                                                ...
                                                                                return (
                                                                                    <div
                                                                                        className={`col-md-3 productimghover ${image === storage.url
                                                                                            ? "activeSize"
                                                                                            : ""
                                                                                            }`}
                                                                                        onClick={() => {
                                    ...
                                    <span className="cusSize">Choose Size</span> */}
                                                                    ...
                                                                    <div className="row">
                                                                        {color?.headboard?.map((headboard) => {
                                                                            if (headboard.url) {
                                                                                ...
                                                                                return (
                                                                                    <div
                                                                                        className={`col-md-3 productimghover ${image === headboard.url
                                                                                            ? "activeSize"
                                                                                            : ""
                                                                                            }`}
                                                                                        onClick={() => {
                                                        ...
                                                        <Tab.Pane eventKey="six">
                                                            <div className="bg-white cusHeight">
                                                                ...
                                                                <div className="container-fluid slider-Mobile">
                                                                    <div className="row">
                                                                        {color?.mattresses_images?.map((mattress) => {
...
export async function getServerSideProps(context) {
    ...
    const data1 = await axios.post(`${process.env.BASE_URL}/api/products/getbeds`, {
        method: ["size", "category"],
        value: [size, "Linen Fabric DivanBeds"]
    });
